        ...
        <div class="panel-setting-main-block">
          <div class="container">
            <div class="plan-block-dtl">
              <h3 class="plan-dtl-heading">Choose your plan</h3>
              <h4 class="plan-dtl-sub-heading">Choose the plan that’s right for you. There's no contract, so you can dip in and out at anytime.</h4>
              <ul>
                <li>Unlimited films and TV programmes.
                </li>
                <li>On up to 3 devices at once.
                </li>
